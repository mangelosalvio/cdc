...
function printESCP() {
    ...
    qz.findPrinter('zebra');
    qz.append(chr(27) + chr(77) + 0);       // font
    //qz.append(chr(29) + chr(33) + 0);       // fo

    qz.append("\n\n");        
    qz.append("________ Internship Program \n");
    qz.append("________ Internship Information Sheet \n");
    qz.append("________ Resume \n");
    qz.append("________ Application Letter \n");
    qz.append("________ Letter of Endorsement \n");
    qz.append("________ Oath of Undertaking \n");
    qz.append("________ Parents / Guardian Consent \n");
    qz.append("________ Monthly DTR \n");
    qz.append("________ Insights \n");
    qz.append("________ Site Evaluation \n");
    qz.append("________ Trainees Performance Evaluation \n");
    qz.append("________ Certficate of Completion \n");
    qz.append("________ Pictures \n\n\n\n\n\n");        
    qz.print();
...
<script type="text/javascript" src="QZ%20Print%20Plugin_files/html2canvas.js"></script>
<script type="text/javascript" src="QZ%20Print%20Plugin_files/jquery.js"></script>



<div style="margin: 0 1em;"><h1 id="title" style="margin:0;">QZ Print Plugin 1.9.4</h1></div>

<table border="1px" cellpadding="5px" cellspacing="0px">
<tbody><tr>
    <td valign="top"><h2>All Printers</h2>
        <input onclick="findPrinter()" value="Detect Printer" type="button"><br>
        <input id="printer" value="zebra" size="15" type="text"><br>
        <input onclick="findPrinters()" value="List All Printers" type="button"><br>
        <input onclick="useDefaultPrinter()" value="Use Default Printer" type="button"><br><br>
    </td>
    ...
    <td valign="top"><h2>Raw Printers Only</h2>
        ...
        <input onclick="printEPL()" value="Print EPL" type="button"><br>
        <input onclick="printZPL()" value="Print ZPL" type="button"><br><br>

        <input onclick="printESCP()" value="Print ESCP" type="button"><br>
        ...
        <input onclick="printEPCL()" value="Print EPCL" type="button"><br>
        (Zebra Card Printer)<br><br>

        <input onclick="print64()" value="Print Base64" type="button"><br>
        <input onclick="printPages()" value="Print Spooling Every 2" type="button"><br>
        <input onclick="printXML()" value="Print XML" type="button"><br>
        <input onclick="printHex()" value="Print Hex" type="button"><br><br>

        <input onclick="printFile('zpl_sample.txt')" value="zpl_sample.txt" type="button"><br>
        <input onclick="printFile('fgl_sample.txt')" value="fgl_sample.txt" type="button"><br>
        <input onclick="printFile('epl_sample.txt')" value="epl_sample.txt" type="button"><br><br>

        <input onclick="printToFile()" value="Print To File" type="button"><br>
        <input onclick="printToHost()" value="Print To Host" type="button"><br>
        <input onclick="useAlternatePrinting()" value="Use Alternate Printing" type="button"><br>
    </td>
    ...
    <td valign="top"><h2>PostScript Printers Only</h2>
        ...
        <input onclick="printHTML()" value="Print HTML" type="button"><br>
        <input onclick="printPDF()" value="Print PDF" type="button"><br>
        <input onclick="printImage(false)" value="Print PostScript Image" type="button"><br>
        <input onclick="printImage(true)" value="Print Scaled PostScript Image" type="button"><br>
        <input onclick="printHTML5Page()" value="Print Current Page" type="button"><br>
        <input onclick="logFeatures()" value="Log Printer Features on Print" type="button"><br>
        <p>Copies</p><p><input id="copies" size="8" value="1" type="text">
    </p></td>

    <td valign="top"><h2>Serial</h2>
        <input id="list_ports" onclick="listSerialPorts()" value="List Serial Ports" type="button"><br>
        <input id="port_name" size="8" type="text"><br>
        <input id="open_port" onclick="openSerialPort()" value="Open Port" type="button"><br>
        <input id="send_data" onclick="sendSerialData()" value="Send Port Cmd" type="button"><br>
        <input id="close_port" onclick="closeSerialPort()" value="Close Port" type="button"><br>
        <hr><h2>Misc</h2>
        <input onclick="listNetworkInfo()" value="List Network Info" type="button"><br>
    </td>
</tr>
</tbody></table>
...
<ins><applet id="qz" code="qz.PrintApplet.class" archive="QZ%20Print%20Plugin_files/qz-print.jar" height="1" width="1">
<param name="jnlp_href" value="./qz-print_jnlp.jnlp"><param name="cache_option" value="plugin"><param name="disable_logging" value="false"><param name="initial_focus" value="false"><param name="separate_jvm" value="true"><param name="codebase_lookup" value="false">
</applet></ins></body></html>