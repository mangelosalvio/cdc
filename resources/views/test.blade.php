...
<head><title>MSALVIO REQ</title>
    ...
    <script type="text/javascript">
        ...
        function printESCP() {
            ...
            $.get('{{ url('/student/print/') }}/'+student_no, function(data){
    ...
    *       qz.getIP()); };
    ...
    <table border="1px" cellpadding="30px" cellspacing="0px" align="center" style="border-radius:4px;">
        <tbody><tr>
            <td valign="top"><h2 style="font-family: Roboto;">Requirements</h2>
                <input type="text" id="student_no" name="student_no" onkeyup="if(event.keyCode== 13) document.getElementById('button').click();" placeholder="Student No" style="padding:3px;" autofocus >
                <input onclick="printESCP()" value="Print" type="button" id="button"><br>
            </td>
    ...
    <p style="font-family: Roboto; font-size:12px; text-align: center;">
        Developed by: <b>Michael Angelo O. Salvio, CpE, MIT</b>
    </p>
