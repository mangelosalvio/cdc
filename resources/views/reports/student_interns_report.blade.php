...
@section('body')
    ...
    <div class="row" style="margin:20px 0px;">
        <iframe id="JOframe" src="{!! url("reports/print-student-interns/$Data[course_id]/$Data[internship_taken_id]/$Data[internship_enrolled_id]/$Data[company_id]?section=$section") !!}" frameborder="0" style="width:100%; height:400px;"></iframe>
    </div>
    @endif
@endsection